...
export const approvedVacations = ['approved', 'requested'];

export const vacationBillabilities = {
  // 'Work From Home (RU/UA/RS/PL)': 'Available',
  'Fully Paid Sick Leave (RU/UA)': 'Funded',
  'Vacation (RU/UA)': 'Funded',
  'Unpaid Leave (PL)': 'Non-billable',
  'Unpaid Vacation (RU/UA)': 'Non-billable',
  'Vacation (PL)': 'Funded',
  'Vacation (US)': 'Funded',
  'Fully Paid Sick Leave (PL)': 'Funded',
  'Fully Paid Sick Leave (RS)': 'Funded',
  'Vacation (RS)': 'Funded',
  'Paid Sick Leave (RU/UA)': 'Funded',
  'Sick Leave (US)': 'Funded',
  'Compensatory Leave (RU/UA)': 'Funded',
  'Paid Sick Leave (PL)': 'Funded',
  'Floating Holiday (US)': 'Funded',
  'Special Leave (PL)': 'Funded',
  'EPSL - Child Care (US)': 'Funded',
  'Maternity Leave (RU/UA)': 'Funded',
  'Paid leave (RS)': 'Funded',
  'Unpaid Vacation (RS)': 'Non-billable',
  'Maternity and Paternity Leave (PL)': 'Funded',
  'Paid Sick Leave (RS)': 'Funded',
  'Parental Leave (US)': 'Funded',
  'Slava Day (RS)': 'Funded',
  'Child Care Leave (PL)': 'Funded',
  'Absence From Work (RU/UA)': 'Non-billable',
  // 'Bereavement Leave (RS)': 'Non-billable',
  // 'Bereavement Leave (RU/UA)': 'Non-billable',
  // 'Bereavement Leave (US)': 'Non-billable',
  // 'Bone Marrow (US)': 'Non-billable',
  'Compensatory Leave (PL)': 'Funded',
  'Compensatory Leave (RS)': 'Funded',
  // 'EPSL (US)': 'Non-billable',
  // 'FMLA Leave (US)': 'Non-billable',
  // 'Jury Duty (US)': 'Non-billable',
  'Maternity and Paternity Leave (RS)': 'Funded',
  'Parental Leave (RU/UA)': 'Funded',
  'Short Term Disability Leave (US)': 'Funded',
  'Study Leave (RU)': 'Funded',
  'Unpaid Leave (US)': 'Non-billable',
};
